      ...
      child: Row(
        children: <Widget>[
          ...
          if (_controlsConfiguration.enablePip)
            ...
            const SizedBox(),
          const Spacer(),
          // Right side: Existing right controls
            ...
            child: AnimatedOpacity(
              ...
              child: ClipRRect(
                ...
                child: Container(
                  ...
                  child: Center(
                    child:
                        _controlsConfiguration.pipMenuIcon ?? const SizedBox(),
                  ),
                ),
              ),
            ),
